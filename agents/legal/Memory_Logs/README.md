...
|----------|---------|------------|
| `Sessions/` | Logs of past legal reviews | Read at start, Write at end |
| `Notes/` | Legal patterns, compliance knowledge | Read when relevant, Write when learning |
| `Lessons.md` | Legal lessons, compliance patterns | Read at start, Write when you learn something |
| `Preferences.md` | Legal review preferences | Read at start, Write when user expresses preference |
...
4. `Lessons.md` - Legal lessons to apply
