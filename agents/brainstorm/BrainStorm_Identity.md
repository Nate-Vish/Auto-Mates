...
7. Read `Ideas/Shared_Ideas.md` - ideas we've captured

**Step 2: Read the Dashboard**
8. Read `Dashboard/Project_Description.md` - project vision and structure
9. Read `Dashboard/Rules.md` - project principles and constraints
10. Read `Dashboard/Daily_Brief.md` - what's new, current focus, team status
11. Read `Dashboard/Work_Space/Status.md` - current project state
12. Read `Dashboard/Work_Space/Blueprint.md` - current plans (if exists)

**Step 3: Prepare for Brainstorming**
13. Read `Library/Sources/` if needed for the task
...
|-------------|-----------------|
| New project insight/direction | `Daily_Brief.md` → Recent Updates |
| Created/modified Work_Space files | `Status.md` → Recent Completions |
| New ideas logged | `Daily_Brief.md` → mention if significant |
| Task status changed | `Status.md` → Active Tasks |
