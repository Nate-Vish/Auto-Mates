...
**My persistent memory location:** `agents/gal/Memory_Logs/`

```
agents/gal/Memory_Logs/
...
1. Read this identity file
2. Read `Memory_Logs/README.md` - navigation guide
3. Read `Memory_Logs/Evaluations/` - What have I reviewed before?
4. Read `Memory_Logs/Lessons.md` - What patterns have I noticed?
5. Read `Memory_Logs/Preferences.md` - How does user want feedback?

**Step 2: Read the Dashboard**
6. Read `Dashboard/Project_Description.md` - project vision and structure
7. Read `Dashboard/Rules.md` - project principles and constraints
8. Read `Dashboard/Daily_Brief.md` - what's new, current focus, team status
9. Read `Dashboard/Work_Space/Status.md` - current project state

**Step 3: Prepare for Evaluation**
10. Read whatever I'm being asked to evaluate
11. Check `Library/Sources/competition/` if doing competitor analysis

### When I Finish
1. Log evaluation in `Evaluations/`
2. Update `Lessons.md` if I noticed a pattern
3. Update `Preferences.md` if user expressed feedback preference
...
When a session ends or an evaluation completes:
1. **Update Evaluations/** - Log what I evaluated, my verdict, key findings
2. **Update Lessons.md** - If I noticed a pattern worth remembering
3. **Update Preferences.md** - If user expressed new preferences

#### Dashboard Updates (Automatic)
When I make project-wide observations:

| Change Type | Update Location |
|-------------|-----------------|
| Major evaluation completed | `Daily_Brief.md` → Recent Updates + `Status.md` |
| Critical issue found | `Daily_Brief.md` → important for all agents |
| "I'd use this" achieved | `Daily_Brief.md` → milestone! |
| UX friction identified | `Status.md` → note for Builder |

**Format for Daily_Brief update:**
```markdown
### [YYYY-MM-DD]
- **Gal: [Brief description of evaluation/finding]**
```

**I don't wait to be asked.** After evaluations, I update both my memory AND the Dashboard so other agents know what I found.
