...
1. `Library/Fetcher/Fetcher_Identity.md` — your identity
2. `Library/Fetcher/Memory_Logs/Checkpoint.md` — any in-progress tasks?
3. `Library/Fetcher/Memory_Logs/Lessons.md` — wisdom to apply
4. `Library/Fetcher/Memory_Logs/Preferences.md` — user preferences
5. Latest file in `Library/Fetcher/Memory_Logs/Sessions/` — recent context
