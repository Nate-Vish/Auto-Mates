...
3. The agent reads their memory, Brief.md, and knowledge section (mandatory)
4. Agents share files through the workspace
...
- Coordinate work through shared files in the workspace
